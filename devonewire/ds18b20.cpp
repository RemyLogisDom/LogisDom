...
ds18b20::ds18b20(net1wire *Master, logisdom *Parent, QString RomID) : onewiredevice(Master, Parent, RomID)
{
	ui.setupUi(this);
	...
	ui.labelfamily->setText(tr("18B20 9-12bit Temp ±0.5°C"));
	...
	setupLayout.addWidget(&ResolutionButton, layoutIndex++, 0, 1, logisdom::PaletteWidth);
...
void ds18b20::contextMenuEvent(QContextMenuEvent * event)
{
...
void ds18b20::SetOrder(const QString &order)
{
...
QString ds18b20::MainValueToStrLocal(const QString &str)
{
	QString S = str;
...
bool ds18b20::setscratchpad(const QString &scratchpad, bool enregistremode)
{
    ...
    if (!checkCRC8(scratchpad)) return IncWarning();		// CRC Wrong
...
double ds18b20::calcultemperature(const QString &THex)
{
    bool ok;
    bool s = false;
...
void ds18b20::GetConfigStr(QString &str)
{
...
void ds18b20::setconfig(const QString &strsearch)
{
